    ...
    return (
        <div>
            <div className="maincard">
                <div className="card">
                    <div className="cardinfo">
                        <img className="imageoflanguage" width="55px" height="55px" src="Images\icon.png" alt="" />
                ...
                <div className="card">
                    <div className="cardinfo">
                        <img className="imageoflanguage" width="55px" height="55px" src="public\Images\docker.png" alt="" />
                ...
                <div className="card">
                    <div className="cardinfo">
                        <img className="imageoflanguage" width="55px" height="55px" src="public\Images\angular.png" alt="" />
            ...
            <div className="maincard">
                <div className="card">
                    <div className="cardinfo">
                        <img className="imageoflanguage" width="55px" height="55px" src="public\Images\html.png" alt="" />
                ...
                <div className="card">
                    <div className="cardinfo">
                        <img className="imageoflanguage" width="55px" height="55px" src="public\Images\javascript.png" alt="" />
                ...
                <div className="card">
                    <div className="cardinfo">
                        <img className="imageoflanguage" width="55px" height="55px" src="public\Images\nextjs.png" alt="" />
            ...
            <div className="maincard">
                <div className="card">
                    <div className="cardinfo">
                        <img className="imageoflanguage" width="55px" height="55px" src="public\Images\python.png" alt="" />
                ...
                <div className="card">
                    <div className="cardinfo">
                        <img className="imageoflanguage" width="55px" height="55px" src="public\Images\react.png" alt="" />
